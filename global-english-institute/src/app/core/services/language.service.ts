...
const TRANSLATIONS = {
  fr: {
    ...
    test: {
      intro: {
        title: 'Test de placement en anglais',
        subtitle: 'Ce test évalue ton niveau en 4 sections. Durée estimée : 30–45 min.',
        start: 'Commencer le test',
        sectionNames: ['Grammaire & Vocabulaire', 'Compréhension écrite', 'Expression écrite', 'Compréhension orale'],
        sectionDetails: ['20 questions', '5 questions', '80–120 mots', '5 questions'],
        before: 'Avant de commencer',
        beforeTips: [
          'Réponds à toutes les sections du mieux que tu peux — il n\'y a pas de mauvaise note',
          'Utilise des écouteurs pour la section audio',
          'La vidéo de présentation sera soumise séparément',
          'Prévois 30–45 minutes sans interruption',
        ],
      },
      personal: {
        title: 'Tes informations',
        subtitle: 'Nous avons besoin de quelques informations pour t\'envoyer tes résultats.',
        name: 'Nom complet',
        email: 'Adresse e-mail',
        phone: 'Numéro de téléphone',
        consent: 'Je consens à ce que Talkr by Easy Learning collecte mes données personnelles pour traiter ce test et me contacter avec les résultats. J\'accepte la',
        consentAnd: 'et la',
        privacy: 'Politique de confidentialité',
        dataUsage: 'Politique de données',
        next: 'Continuer vers la Grammaire',
      },
      grammar: {
        title: 'Section 1 — Grammaire & Vocabulaire',
      ...
      reading: {
        title: 'Section 2 — Compréhension écrite',
        instruction: 'Lisez le texte attentivement, puis répondez à chaque question en quelques phrases.',
        passage: 'Texte de lecture',
        next: 'Continuer vers l\'Expression écrite',
        answered: 'réponse(s) sur',
      },
      writing: {
        title: 'Section 3 — Expression écrite',
        instruction: 'Répondez à la consigne en 80–120 mots. Votre réponse sera corrigée par un instructeur.',
        prompt: 'Consigne',
        placeholder: 'Écrivez votre réponse ici...',
        words: 'mots',
        tooFew: 'Minimum 80 mots',
        tooMany: 'Essayez de rester sous 120 mots',
        next: 'Continuer vers la Compréhension orale',
      },
      listening: {
        title: 'Section 4 — Compréhension orale',
        instruction: 'Appuyez sur Lecture pour entendre le texte à voix haute. Vous pouvez écouter plusieurs fois, puis répondez aux questions.',
        play: 'Écouter',
        stop: 'Arrêter',
        playing: 'En cours de lecture…',
        ready: 'Prêt à écouter',
        readyHint: 'Le texte sera lu à voix haute en anglais',
        transcript: 'Voir la transcription',
        hideTranscript: 'Cacher la transcription',
        transcriptLabel: 'Transcription',
        answered: 'réponse(s) sur',
        submitTitle: 'Prêt à soumettre ?',
        submitHint: 'Tes réponses de grammaire sont notées automatiquement. La lecture, l\'écriture et l\'écoute seront corrigées dans les 48h.',
      },
      results: {
        title: 'Test soumis !',
        subtitle: 'Merci. Tes réponses ont bien été enregistrées. Une confirmation a été envoyée à',
        grammarScore: 'Score Grammaire (automatique)',
        grammarNote: 'Il s\'agit uniquement de ton score en grammaire. Ton niveau final sera déterminé après la correction complète.',
        breakdown: 'Détail des scores',
        ...
        s1: 'Vérifie tes e-mails — une confirmation avec ton score de grammaire a été envoyée.',
        s2: 'Tes réponses écrites et orales seront corrigées dans les 48 heures. Tu recevras ton niveau final (Débutant, Intermédiaire ou Avancé).',
        s3: 'Un membre de notre équipe te contactera par WhatsApp ou e-mail pour discuter du programme adapté à ton niveau.',
  ...
  en: {
    ...
    test: {
      intro: {
        ...
        subtitle: 'This test evaluates your level across 4 sections. Estimated time: 30–45 min.',
        start: 'Start Test',
        sectionNames: ['Grammar & Vocabulary', 'Reading Comprehension', 'Writing Task', 'Listening Comprehension'],
        sectionDetails: ['20 questions', '5 questions', '80–120 words', '5 questions'],
        before: 'Before you begin',
        beforeTips: [
          "Answer all sections as best you can — there are no penalties for wrong answers",
          'Use headphones or speakers for the listening section',
          'The speaking video will be submitted separately',
          'Set aside 30–45 uninterrupted minutes',
        ],
      },
      personal: {
        title: 'Your Details',
        subtitle: 'We need some basic information to send you your results.',
        name: 'Full Name',
        email: 'Email Address',
        phone: 'Phone Number',
        consent: 'I consent to Talkr by Easy Learning collecting my personal data to process this placement test and contact me with results. I agree to the',
        consentAnd: 'and',
        privacy: 'Privacy Policy',
        dataUsage: 'Data Usage Policy',
        next: 'Continue to Grammar',
      },
      grammar: {
        title: 'Section 1 — Grammar & Vocabulary',
      ...
      reading: {
        ...
        instruction: 'Read the passage carefully, then answer each question in your own words.',
        passage: 'Reading Passage',
        next: 'Continue to Writing',
        answered: 'answered of',
      },
      writing: {
        title: 'Section 3 — Writing Task',
        instruction: 'Write your response in 80–120 words. It will be reviewed by an instructor.',
        prompt: 'Writing Prompt',
        placeholder: 'Write your response here...',
        words: 'words',
        tooFew: 'Minimum 80 words',
        tooMany: 'Try to stay within 120 words',
        next: 'Continue to Listening',
      },
      listening: {
        title: 'Section 4 — Listening Comprehension',
        instruction: 'Press Play to hear the passage read aloud. You can listen multiple times, then answer the questions below.',
        play: 'Play Audio',
        stop: 'Stop',
        playing: 'Playing…',
        ready: 'Ready to listen',
        readyHint: 'The passage will be read aloud in English',
        transcript: 'Show transcript',
        hideTranscript: 'Hide transcript',
        transcriptLabel: 'Transcript',
        answered: 'answered of',
        submitTitle: 'Ready to Submit?',
        submitHint: 'Your grammar answers will be scored immediately. Reading, writing, and listening responses will be reviewed within 48 hours.',
      },
      results: {
        title: 'Test Submitted!',
        subtitle: 'Thank you. Your answers have been saved. A confirmation has been sent to',
        grammarScore: 'Grammar Auto-Score',
        grammarNote: 'This is your grammar & vocabulary score only. Your full level will be determined after instructor review.',
        ...
        s1: 'Check your email — a confirmation with your grammar score has been sent.',
        s2: 'Your reading, writing, and listening responses will be reviewed within 48 hours. You will receive your final level (Beginner, Intermediate, or Advanced).',
        s3: 'A member of our team will contact you via WhatsApp or email to discuss the right program for your level.',
